/**********************************************************************
 *  Launchpad demóprogram: ADC_pwm3
 *
 ...
 * A PWM kitöltés frissítéséhez hardveresen (DTC-vel) mozgatjuk át a 
 * konverzió eredményét az ADC10MEM regiszterbõl a TACCR1 regiszterbe.
